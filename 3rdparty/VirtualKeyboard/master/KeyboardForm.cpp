...
const char *btnqss = "QPushButton{color:#FFFFFF; border-image: url(:/images/btn2.png); border-width: 5;} "
                     "QPushButton:pressed{border-image: url(:/images/btn3.png); border-width: 5;}"
                     "QPushButton:hover{border-image: url(:/images/btn3.png); border-width: 5;}";
    ...
    QDialog(parent)
{
    ...
    setStyleSheet("QLabel{font: bold normal 18px 'Consolas'} QWidget QPushButton{border-image: url(:/images/btn1.png); border-width: 5; font: bold normal } "
                  "QPushButton:pressed{border-image: url(:/images/btn3.png); border-width: 5;}"
                  "QPushButton:hover{border-image: url(:/images/btn3.png); border-width: 5;}");
    ...
    m_btnShift->setStyleSheet(btnqss);
    ...
    m_btnSymbol->setStyleSheet(btnqss);
    ...
    m_btnChange->setStyleSheet(btnqss);
